...
steps:
  ...
  primary-malignancy_cervical-history---primary:
    run: primary-malignancy_cervical-history---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: primary-malignancy_cervical-history---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
